...
const Instagram = () => {
  return (
    <div
      className="h-450 flex items-center justify-center mt-6"
      style={{
    ...
    >
      <div className="text-center p-5">
        ...
        <button className="bg-[#FAF4F4] text-black h-12 w-30 md:w-48 rounded-3xl shadow-md flex items-center justify-center mx-auto transition-transform duration-300 hover:scale-110">
  <span>Follow Us</span>
</button>
